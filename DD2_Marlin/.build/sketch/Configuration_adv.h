...
#define FWRETRACT  // ONLY PARTIALLY TESTED
  ...
  #define RETRACT_FEEDRATE 9600/60             // Default feedrate for retracting (mm/s)
  ...
  #define RETRACT_RECOVER_LENGTH_SWAP -0.01   // Default additional swap recover length (mm, added to retract length when recovering from extruder change)
  #define RETRACT_RECOVER_FEEDRATE 2700/60      // Default feedrate for recovering from retraction (mm/s)
  #define RETRACT_RECOVER_FEEDRATE_SWAP 1750/60 // Default feedrate for recovering from swap retraction (mm/s)
#endif
